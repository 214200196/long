...
<div class="bodyer clearfix">
            ...
            <dl class="sidebar">
                ...
                <dd>
                    ...
                    <div class="mianright">
                    	<h2><?php echo ($_G["site_result"]["name"]); ?><span><a href="/">首页</a> > <?php echo ($_G["site_result"]["name"]); ?></span></h2>
                        <p><img src="<?php echo ($tpldir); ?>zhuliu/images/about_02.jpg" width="650" height="130" /></p>
                        <ul class="news">
                        	
                 
				<?php if(is_array($list)): foreach($list as $key=>$var): ?><li><span><?php echo (date("Y-m-d H:i:s",$var["addtime"])); ?></span><a href="<?php echo U('index/index?site='.$_G['site_result']['nid'].'&id='.$var['id']);?>"><?php echo ($var["name"]); ?></a></li><?php endforeach; endif; ?>
