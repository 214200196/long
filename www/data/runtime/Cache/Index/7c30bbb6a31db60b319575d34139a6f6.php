...
<div class="bodyer clearfix">
            ...
            <dl class="sidebar">
                ...
                <dd>
                    ...
                    <div class="mianright"><style type="text/css">
                    .mianright p{  text-align:left}
                    </style>
             	<h2><span><a href="/">首页</a> > <?php echo ($_G["site_result"]["name"]); ?> > <?php echo ($_G["articles_result"]["name"]); ?></span></h2>
                        <p><img src="<?php echo ($tpldir); ?>zhuliu/images/about_02.jpg" width="650" height="130" /></p>
                        <div style="text-align:left"><p> <?php echo (htmlspecialchars_decode($_G["articles_result"]["contents"])); ?></p></div>
                    </div>	
                </div>
