...
<div class="bodyer clearfix login_box">
	<div class="login-left">
		<img src="<?php echo ($tpldir); ?>longbao/images/login_03.jpg" width="653"
			height="390" />
	</div>
	<form action="<?php echo U('index/login');?>" method="post" name="login_in_form">

		<div class="login-right">
			<div class="control_group mb20">

				<div class="controls">
					<input type="text" name="keywords" id="keywords" class="inputBox"
						placeholder="请输入用户名">
				</div>
			</div>
			<div class="control_group mb10">
				...
				<div class="controls">
					<input type="password" code="ie_psw1" class="inputBox password_new"
						placeholder="请输入密码" name="password" id="password" value="">
				</div>
			</div>
			<div class="control_group mb20 mt20"></div>
			<div class="control_group mb20">
			...
			<div class="control_group">
				...
				<div>
					<p class="lable-text">
						<a href="<?php echo U('index/reg');?>">免费注册</a> <a href="<?php echo U('index/getpwd');?>">忘记密码</a>
					</p>
				</div>
			</div>
		</div>
