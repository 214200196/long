        ...
        <div class="top_div"></div>
            ...
            <form action="<?php echo U('checkLogin');?>" method="POST">
                ...
                <P style="position: relative;margin-top:10px;"><span class="p_logo"></span>         
                    ...
                    <img href="javascript:void(0)" alt="点击刷新" onClick="this.src='<?php echo U('Login/verify','','');?>/'+ Math.random()" src="<?php echo U('Login/verify');?>" style="width:120px; height:35px;margin-left:20px;position:relative;top:12px;"/> 
                </P>
