    ...
    <div class="course-tool-bar clearfix">
        ...
        <div class="tool-right r">
            ...
            <span class="tool-item tool-pager">
                ...
                <?php if($_GET['p'] != 1): ?><a href="<?php echo U('index',array('p'=>$_GET['p']-1));?>" class="glyphicon glyphicon-arrow-left"></a>&nbsp;&nbsp;<?php endif; ?>
                <?php if($_GET['p'] < $totalPage): ?><a href="<?php echo U('index',array('p'=>$_GET['p']+1));?>" class="glyphicon glyphicon-arrow-right"></a><?php endif; ?>
            </span>
        </div>
    </div>
