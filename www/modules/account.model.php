...
$MsgInfo ["account_name_recharge_jiangli"] = "充值奖励";
...
$Linkages ['account_recharge_type'] = array ( "1"=>"线上充值", "2"=>"手动充值", "0"=>"线下充值" );
$Linkages ['account_recharge_status'] = array ( "1"=>"审核成功", "2"=>"审核失败", "0"=>"待审核" );
$Linkages ['account_cash_status'] = array ( "1"=>"成功", "2"=>"审核失败", "0"=>"申请", "3"=>"撤销" );
