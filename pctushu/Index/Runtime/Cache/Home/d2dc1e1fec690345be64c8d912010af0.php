            ...
            <div class="col-sm-6 col-md-4">
              <div  class="thumbnail" >
                ...
                <div class="caption">
                  ...
                  <p><a href="<?php echo U('Books/index',array('bid'=>$v['id'],'content_id'=>$getMiniContentId['content_id']));?>" class="btn btn-primary" role="button">在线阅读</a> <a href="<?php echo U('Member/addFollow',array('bid'=>$v['id']));?>" class="btn btn-default" role="button">关注<strong style="color:red;" class="glyphicon glyphicon-heart-empty"></strong></a></p>
                </div>
              </div>
            </div>
